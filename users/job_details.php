...
if ($job['status'] == "COMPLETED") {
  ...
  echo "<h1 class='h3 mb-3 fw-normal'>Write a Review</h1>";
  ...
  echo "<textarea style='height: 100px' type=text name=review_comment class=form-control id=floatingInput rows=4 cols=50 required=true>$comment</textarea>";
  echo "<label for=floatingInput class=text-dark>Comment</label>";
  echo "</div>";
  echo "<div class=form-floating>";
  echo "<input type=number name=rating class=form-control id=floatingInput required=true min=1 max=5 step='0.5'/>";
  echo "<label for=floatingInput class=text-dark>Rating</label>";
  echo "</div>";
  echo "<div class=form-floating>";
  echo "<input type=password name=pin class=form-control id=floatingInput required=true/>";
  echo "<label for=floatingInput class=text-dark>Pin</label>";
  echo "</div>";
  echo "<input type=text name=cat_id value=$job[cat_id] hidden=true>";
  echo "<input type=text name=tradesman_id value=$job[tradesman_id] hidden=true>";
  echo "<input type=text name=job_id value=$job_id hidden=true>";
  echo "<button class='w-100 btn btn-lg text-light mt-3' type=submit style='background-color: #5b9bd5'>Submit Review</button>";
  echo "</form>";
  echo "</main>";
  echo "</div>";
  echo "</div>";
  ...
  echo "<option class=dropdown-item value=CANCELLED>Cancel</option>";
  echo '</select>';
  echo "</div>";
  echo "<input type=text name=job_id value=$job_id hidden=true>";
