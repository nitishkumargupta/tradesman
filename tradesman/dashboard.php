...
$q = "SELECT * from jobs where tradesmand = '$user' and status = 'PENDING'";
$r = $dbc->query($q);
...
?>
<?php
$q = "SELECT * from jobs where tradesmand = '$user' and status = 'CONFIRMED'";
$r = $dbc->query($q);
echo "<div class='card rounded-5' style='
          width: 30rem;
          min-height: 20rem;
...
?>
<?php
$q = "SELECT * from jobs where tradesmand = '$user' and status = 'REJECTED'";
$r = $dbc->query($q);
echo "<div class='card rounded-5' style='
          width: 30rem;
          min-height: 20rem;
...
?>
<?php
$q = "SELECT * from jobs where tradesmand = '$user' and status = 'COMPLETED'";
$r = $dbc->query($q);
echo "<div class='card rounded-5' style='
          width: 30rem;
          min-height: 20rem;
